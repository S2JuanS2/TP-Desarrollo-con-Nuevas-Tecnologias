...
class AdministradorService {
    ...
    // registrar las calificaciones proporcionadas por un cliente en tres aspectos diferentes. Estas calificaciones se suman a los contadores correspondientes en el objeto Administrador. La función es transaccional para garantizar la consistencia de los datos en la base de datos. 
    @Transactional
